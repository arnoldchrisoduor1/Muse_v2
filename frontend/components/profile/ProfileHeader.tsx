...
interface ProfileHeaderProps {
  ...
  onFollow: (followerId: string, targetId: string) => void;
  onUnfollow: (followerId: string, targetId: string) => void;
}

export function ProfileHeader({ profile, isOwnProfile, onFollow, onUnfollow, target }: ProfileHeaderProps) {
                ...
                {isOwnProfile ? (
                  ...
                  <>
                    ...
                    <Button 
                      ...
                      onClick={() => isFollowing ? onUnfollow(profile.id, target.id) : onFollow(profile.id, target.id)}
                    >
